...
interface tokenRecipient {
    function receiveApproval(
        address _from, uint256 _value, address _token, bytes memory _extraData
...
contract TokenERC20 {
/*********Token的属性说明************/
    string public name = "3434";
    string public symbol = "3434";
    ...
    // 这里是构造函数, 实例创建时候执行
    function TokenERC20s(uint256 initialSupply, string memory tokenName, string memory tokenSymbol) public {
